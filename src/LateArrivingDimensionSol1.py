...
print("\n Although showing the NULL SK records but they must be filtered and not processed until dimension values arrive.\n")
...
o.*, 
case 
    when o.customer_sk is null or o.product_sk is null then False 
    else True end as processed_flag 
from fact_orders o
where
o.customer_sk is null or o.product_sk is null''')
...
sf.status
from
suspended_fact_order sf

''')

print("\n The new order file after processing would look like below :\n")
fact_order_df.show(truncate=False)
